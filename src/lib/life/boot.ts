...
const INTERACTIVE = 'a, button, input, textarea, select, label, summary, dialog, [data-no-life], .sheet, .card, .hud, .cut--card, .chat, .overlays, [data-lab], [data-atlas], [data-network], [data-tamburo], [data-stochos], [data-attr], [data-orfeo], .boons, [data-melencolia], [data-logic], [data-unveiled] canvas, .toc, .legend';
