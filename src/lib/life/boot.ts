...
const INTERACTIVE = 'a, button, input, textarea, select, label, summary, dialog, [data-no-life], .sheet, .card, .hud, .cut--card, .chat, .overlays, [data-lab], [data-atlas], [data-network], [data-tamburo], [data-orfeo], .boons, [data-logic], [data-unveiled] canvas, .toc, .legend';
