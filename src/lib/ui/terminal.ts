...
const PAGES: Record<string, string> = { lab: '/lab/', atlas: '/atlas/', network: '/network/', unveiled: '/unveiled/', logic: '/logic/', drums: '/drums/', synth: '/synth/', vocoder: '/vocoder/', zoo: '/archive/', about: '/about/', home: '/' };
