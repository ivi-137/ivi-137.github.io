...
| **Stochos 64** `/sequencer/` | 8-track, up to 128-step MIDI sequencer with song mode, trig conditions, p-locks, polymeter; UPIC-style drawing; sieves, Poisson clouds, Brownian walks, Markov chains, cube-group (Nomos Alpha), CA, Euclid, Fibonacci word, logistic map; MIDI clock in/out, .mid export. Checks: `scripts/check-stochos.mts` |
